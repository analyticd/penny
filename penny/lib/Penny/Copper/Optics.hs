...
-- "Penny.Copper.Types" are in this module.  Most of these values are
-- generated by Template Haskell, though several are written by hand.
...
-- * Automatically-generated optics
