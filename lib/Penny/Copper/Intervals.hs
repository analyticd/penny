-- | Helpers for dealing with intervals.  Intended for the character
-- sets in the YAML specification.
module Penny.Copper.Intervals
  ( -- * Single interval
    Interval
  , singleton
  , range
...
import Penny.Copper.Intervals.Interval
