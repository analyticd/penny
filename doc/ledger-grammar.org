...
<postingMemoLine> ::= White* Apostrophe NonNewline* Newline

** Transaction memo

<transactionMemoLine> ::= White* Semicolon NonNewline* Newline
...
<price> ::= White* <dateTime> White* <fromCmdty> White+ <amount> Newline
...
<topLineFlagNum> ::= <flag>? White* <number>?
                     | <number>? White* <flag>?
<topLine> ::= White* <transactionMemoLine>* <dateTime> White*
              <topLineFlagNum> White* <topLinePayee> Newline
...
<posting>
  ::= White* <postingFlagNumPayee> White* <postingAcct> White*
      <tags>? White* <entry>? White* Newline
